...
1.   my points：读取接口 A01
2.   points records：读取接口 A01
3.   invite friends：调用 flutter 系统模块，分享 app 链接+ current user code
4.   new user request：一个特殊的 actvity
5.   daily request： 今天可用的 actvity
